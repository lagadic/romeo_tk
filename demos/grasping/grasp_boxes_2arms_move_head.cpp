...
int main(int argc, const char* argv[])
{
  ...
  angles_head      = AL::ALValue::array(vpMath::rad(0.0), vpMath::rad(27.7), vpMath::rad(-2.6), vpMath::rad(0), 0.0, -0.2, 0.0, -0.1  );
  ...
  while(1) {
    ...
    vpImageConvert::convert(cvI_l, I[0]);
    vpImageConvert::convert(cvI_r, I[1]);
