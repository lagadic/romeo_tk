...
int main(int argc, const char* argv[])
{
  try
  {
    ...
    AL::ALSoundLocalizationProxy tts(opt_ip, 9559);


    tts.subscribe("Test_audio");
...
//    std::cout << "Speech recognition engine started" << std::endl;
    ...
    while (1)
    {
      AL::ALValue result = memProxy.getData("ALSoundLocalization/SoundLocated");
